...
Partial Public Class HowToImplementDetailViewItemWindowsFormsApplication
	...
	Private Sub HowToImplementDetailViewItemWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
